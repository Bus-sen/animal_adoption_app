...
class ShelterRequestListPage extends StatefulWidget {
  const ShelterRequestListPage({super.key});

  @override
  State<ShelterRequestListPage> createState() => _ShelterRequestListPageState();
}

class _ShelterRequestListPageState extends State<ShelterRequestListPage> {
  List _adverts = [];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: BigText(
            text: "Gelen İstekler", size: 24, color: Colors.white,
          ),
        ),
      ),
      body: Padding(
